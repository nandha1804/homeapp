...
public class AddcartController {
	...
	public long addto(@PathVariable("pid") int pid,@RequestParam("uid") int uid,@RequestParam("quantity") int quantity,@RequestParam("size") int size) {
		System.out.println("enter");
	    long x=service.fun(pid,uid,quantity,size);
	    return x;
