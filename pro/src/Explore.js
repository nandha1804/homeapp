...
const filterfootwear=allProducts.filter(products=>{

  const categoryMatch=category==='all'||products.footwearname===category;

  const searchMatch = products.footwearname.toLowerCase().includes(search.toLowerCase());
...
return (
  <div>
    ...
    <table><tr>
      <td className="heading">FootwearStore</td>
      <td>
    <form>
  ...
  <Card style={{ width: '18rem' }}>
    ...
    <Card.Body>
      <Card.Title>{ap.footwearname}</Card.Title>
      <Card.Text>Brand:{ap.brandname}
      </Card.Text>
