...
public class ProductService {
	...
	public void saveProduct(MultipartFile image,String footwearname,String brandname,int price,int availability) throws IOException {
		Product product=new Product();
		product.setImage(image.getBytes());
		product.setFootwearname(footwearname);
	...
	public String updateProductId(int id,MultipartFile image,String footwearname,String brandname,int price,int availability) throws IOException
	{
		...
		produ.setFootwearname(footwearname);
		produ.setBrandname(brandname);
